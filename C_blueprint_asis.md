...
|---|---|---|---|---|---|---|---|---|
| **CAMADA 1 — Evidências Físicas** *(Physical Evidence)* | Formulário Empregador Web; cópia do formulário recebida do empregador; TRCT; tela de login gov.br no celular/PC; tela "solicitar o seguro-desemprego"; comprovante de requerimento gerado pelo sistema [N] | Tela do celular com o número 0800-726-0207 discado; CPF e documento com a data de nascimento em mãos; anotação do número | Tom de discagem; voz da locução "Atendimento CAIXA Cidadão"; aviso sonoro de gravação; menu falado com os números das teclas [T] | Locução pedindo CPF e data de nascimento; bipes do teclado numérico ao digitar; tom de confirmação ou de erro [T] | Locução do submenu enumerando "situação/parcelas — 1, pagamento — 2, falar com atendente — 0" [T] | Música de espera; eventual locução de posição na fila ou de indisponibilidade fora do horário [T] | Voz do atendente humano; número de protocolo ditado verbalmente; orientação falada para gov.br/158 [T] | Sinal sonoro de encerramento; tela do celular registrando a duração da chamada; protocolo anotado pelo cidadão [T] |
...
| **P7 — Evidências** | Sólidas/observáveis [N]/[O]/[T]; só SMS/push [I] fora | ✓ Camada 1 usa [N] (pré/pós) e [T] (locuções, CPF+data, protocolo verbal — observados na ligação); SMS/push em nota [I] |
